# LCR Leader Election Protocol Using RMI
This repository contains two java implementations of the LCR Leader Election Protocol. One uses a peer-register to register nodes, the other does not rely on a peer register. Each implementation is on its own directory and has its own 'README.md' file that contains instructions to run the code.
